...
class PandasCompatibilityTester:
    ...
    def test_basic_operations(self):
        ...
        self.run_test(
            ...
            "Basic Operations",
            lambda: df.head(10),
            lambda: self._ds_from_df(df).head(10)
        )
        ...
        self.run_test(
            ...
            "Basic Operations",
            lambda: df.tail(10),
            lambda: self._ds_from_df(df).tail(10)
        )
        ...
        self.run_test(
            ...
            "Basic Operations",
            lambda: df.shape,
            lambda: self._ds_from_df(df).shape
        )
        ...
        self.run_test(
            ...
            lambda: list(self._ds_from_df(df).columns)
        )
    ...
    def test_filtering_operations(self):
        ...
        self.run_test(
            ...
            lambda: self._ds_from_df(df)[
                (self._ds_from_df(df)['class_label'] == 'cat') &
                (self._ds_from_df(df)['brightness'] > 150)
            ].to_df()
        )
        ...
        self.run_test(
            ...
            lambda: self._ds_from_df(df)[
                self._ds_from_df(df)['class_label'].isin(['cat', 'dog'])
            ].to_df()
        )
    ...
    def test_aggregation_operations(self):
        ...
        self.run_test(
            ...
            "Aggregation",
            lambda: df['sales'].min(),
            lambda: self._ds_from_df(df)['sales'].min()
        )
        ...
        self.run_test(
            ...
            "Aggregation",
            lambda: df['sales'].max(),
            lambda: self._ds_from_df(df)['sales'].max()
        )
    ...
    def test_missing_data_operations(self):
        ...
        self.run_test(
            ...
            "Missing Data",
            lambda: df.isna(),
            lambda: self._ds_from_df(df).isna()
        )
        ...
        self.run_test(
            ...
            "Missing Data",
            lambda: df.dropna(),
            lambda: self._ds_from_df(df).dropna()
        )
    ...
    def test_string_operations(self):
        ...
        self.run_test(
            ...
            lambda: self._ds_from_df(df)[
                self._ds_from_df(df)['text'].str.contains('sample')
            ].head(10).to_df()
        )
    ...
    def test_merge_operations(self):
        ...
        self.run_test(
            ...
            lambda: pd.merge(
                self._ds_from_df(df1).to_df(),
                self._ds_from_df(df2).to_df(),
                on='key',
                how='inner'
            )
        )
    ...
    def test_rename_operations(self):
        ...
        self.run_test(
            ...
            lambda: self._ds_from_df(df).rename(columns={
                'brightness': 'bright',
                'contrast': 'contr'
            }).head(10)
        )
