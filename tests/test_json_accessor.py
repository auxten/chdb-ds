...
class TestJsonAccessorBasic:
    ...
    def test_json_extract_string_returns_function(self, ds_with_json):
        """Test that .json.json_extract_string() returns Function object."""
        result = ds_with_json['data'].json.json_extract_string('name')
        assert isinstance(result, Function)

    def test_json_extract_int_returns_function(self, ds_with_json):
        """Test that .json.json_extract_int() returns Function object."""
...
class TestJsonLazyExecution:
    ...
    def test_json_ops_return_function(self):
        """Test that JSON operations return Function objects."""
        ...
        assert isinstance(str_expr, Function)
        assert isinstance(int_expr, Function)
...
class TestJsonDirectSQL:
    ...
    def test_json_sql_generation(self):
        ...
        json_func = ds['data'].json.json_extract_string('name')
        sql_repr = str(json_func)
